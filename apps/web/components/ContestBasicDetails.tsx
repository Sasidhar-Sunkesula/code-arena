            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormDescription>
                            This will be visible as contributed by when people look at your contest.
                        </FormDescription>
                        <FormMessage />
                    </FormItem>
                )}
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input className="w-full md:w-11/12" placeholder="Basic Booster" {...field} />
                        </FormControl>
                        <FormDescription>
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <Select value={field.value} onValueChange={field.onChange}>
                                ...
                                <SelectContent>
                                    <SelectItem value={ContestLevel.BEGINNER}>Beginner</SelectItem>
                                    <SelectItem value={ContestLevel.INTERMEDIATE}>Intermediate</SelectItem>
                                    <SelectItem value={ContestLevel.ADVANCED}>Advanced</SelectItem>
                                </SelectContent>
                            </Select>
                        </FormControl>
                        <FormDescription>
