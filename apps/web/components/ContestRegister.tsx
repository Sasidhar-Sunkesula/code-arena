    ...
    try {
      ...
      toast.error(
        error instanceof Error
          ? error.message
          : "An error occurred while registering for the contest.",
      );
    } finally {
      setLoading(false);
    }
  ...
  async function handleUnregister() {
    ...
    try {
      ...
      toast.error(
        error instanceof Error
          ? error.message
          : "An error occurred while unregistering from the contest.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {isRegistered
                ? "Are you sure you want to unregister from the contest?"
                : "Are you sure you want to register for the contest?"}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {isRegistered
                ? "If you change your mind, you can register again before the contest starts."
                : "If you change your mind, make sure to unregister."}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              disabled={loading}
              onClick={isRegistered ? handleUnregister : handleParticipate}
            >
              {loading ? (
