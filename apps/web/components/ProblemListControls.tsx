...
export function ProblemListControls() {
  ...
  return !problemList ? (
    <div className="md:h-[450px] border p-2 text-destructive font-semibold flex justify-center items-center">
