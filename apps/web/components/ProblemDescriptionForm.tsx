...
export function ProblemDescriptionForm({
  control,
}: ProblemDescriptionFormProps) {
      ...
      render={({ field }) => (
        <FormItem>
          ...
          <ul className="px-4 text-sm list-disc space-y-2">
            ...
            <li>
              The description should contain the problem description,
              constraints and sample inputs and outputs.
            </li>
            <li>
              <a
                target="_blank"
